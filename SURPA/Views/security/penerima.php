        ...
        <div class="row">
            ...
            <main class="col-md-10 ml-sm-auto px-4 main-content">
                ...
                <div class="card-body">
                        ...
                        <p class="card-text" ><?php echo $jumlah_penerima[0]['total']; ?></p>
                    </div>
                <h2>Data Penerima</h2>
                    ...
                    <?php if (!empty($penerima)) : ?>
                        <div class="table-responsive" style="max-height: 30em; overflow-y: auto;">
                            <table id="myTable" class="table table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($penerima as $index => $data) : ?>
                                        <tr>
                                            <td><?php echo $index + 1; ?></td>
                                            <td><?php echo $data['id_penerima']; ?></td>
                                            <td><?php echo $data['nama_penerima']; ?></td>
                                            <td><button class="btn btn-warning" onclick="document.location='index.php?page=formUpdatePenerima&id_penerima=<?php echo $data['id_penerima']; ?>'"><i class="bi bi-pencil-square"></i></button>
                                                <button class="btn btn-danger" onclick="confirmDeletion('<?php echo $data['id_penerima']; ?>')">
