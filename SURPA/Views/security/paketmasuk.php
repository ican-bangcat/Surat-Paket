    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-10 ml-sm-auto px-4 main-content">
                ...
                <!-- Card Total Paket Masuk -->
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">Total Paket Masuk</h5>
                        <p class="card-text" id="totalPaketMasuk"><?php echo $jumlah_paket_sekarang[0]['total']; ?></p>
                    </div>
                </div>
                
                <div class="d-flex justify-content-between mb-3">
                    <button class="btn btn-primary" onclick="document.location='index.php?page=forminsert'">
                        <i class="bi bi-box2-fill"></i>&nbsp;Tambah paket masuk
                    </button>
                </div>
                <!-- <div class="search-container">
                    <form action="index.php?page=paketmasuk" method="post">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari nama penerima atau nomor resi paket anda" name="carimasuk" id="c" autocomplete="off">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <img src="Views/assets/loki.png" alt="Cara Memakai Halaman Input Data Paket" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
