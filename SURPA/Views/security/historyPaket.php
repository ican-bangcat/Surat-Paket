    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-10 ml-sm-auto px-4 main-content">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">Total Paket Dihapus</h5>
                        <p class="card-text" id="totalPaketMasuk"><?php echo $jumlah_paket_dihapus[0]['total']; ?></p>
                    </div>
                </div>
                <!-- <div class="search-container">
                    <form action="index.php?page=history" method="post">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari nama penerima atau nomor resi paket anda" name="cariHistory" id="cariHistory" autocomplete="off">
